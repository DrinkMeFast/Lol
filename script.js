...
const products = [
    {
        id: 1,
        name: "Herbal Care Ginseng & Nettle Duo",
        category: "haircare",
        price: 42,
        originalPrice: 52,
        image: "images/products/herbal-care-satin.jpg",
        badge: "New",
        description: "A botanical hair ritual: a ginseng conditioner that strengthens and thickens fine, delicate hair, paired with a nettle shampoo that balances oily scalps. 98% and 96% ingredients of natural origin.",
        usage: "Wash with the nettle shampoo, rinse, then apply the ginseng conditioner to the lengths for 2-3 minutes and rinse.",
        ingredients: "Ginseng Extract, Nettle Extract, Plant-Derived Cleansers, Conditioning Agents."
    },
    {
        id: 2,
        ...
        price: 18,
        originalPrice: null,
        image: "images/products/dabur-amla-hair-oil.jpg",
        badge: "Bestseller",
        description: "The classic amla hair oil enriched with vitamins A & E. Nourishes from root to tip for hair that grows long, strong and dark. 200 ml.",
        usage: "Massage into scalp and hair, leave for at least an hour or overnight, then wash.",
        ingredients: "Amla (Indian Gooseberry) Extract, Vegetable Oils, Vitamin A, Vitamin E."
    },
    {
        id: 3,
        name: "Disaar Aloe Vera Soothing Gel",
        category: "skincare",
        price: 16,
        originalPrice: 22,
        image: "images/products/disaar-aloe-vera-gel.jpg",
        badge: "Sale",
        description: "99% aloe vera gel that soothes, moisturises and cools the skin. Perfect after sun exposure and for everyday hydration of face and body. 300 ml.",
        usage: "Apply generously to clean skin as needed, especially after sun.",
        ingredients: "Aloe Barbadensis Leaf Juice, Glycerin, Carbomer."
    },
    {
        id: 4,
        name: "Orchid Deodorant Cream",
        category: "bodycare",
        price: 12,
        originalPrice: null,
        image: "images/products/orchid-deodorant-cream.jpg",
        badge: "Alcohol Free",
        description: "Alcohol-free deodorant cream with natural herbal extracts. Neutralises odour with a long-lasting effect for several days. 30 ml.",
        usage: "Apply a small amount to clean, dry underarms.",
        ingredients: "Natural Herbal Extracts. Alcohol free."
    },
    {
        id: 5,
        name: "Nivelazione Foot Care Set",
        category: "bodycare",
        price: 24,
        originalPrice: null,
        image: "images/products/nivelazione-foot-care.jpg",
        badge: null,
        description: "Odour-blocking antiperspirant foot cream plus a 4-in-1 foot deodorant spray. Reduces excessive sweating and keeps feet dry and fresh all day.",
        usage: "Apply the cream to clean, dry feet in the evening; use the spray on feet and inside shoes during the day.",
        ingredients: "Mint Extract, Sage Extract, Odour-Neutralising Technology."
    },
    {
        id: 6,
        name: "So Well Depilatory Cream Spray",
        category: "bodycare",
        price: 14,
        originalPrice: null,
        image: "images/products/sowell-depilatory-spray.jpg",
        badge: null,
        description: "Hair removal cream in an easy spray for all body areas. Leaves skin smooth with a moisturising effect. 120 ml.",
        usage: "Spray evenly on dry skin, leave for 5-10 minutes, then remove and rinse. Do a patch test first.",
        ingredients: "Depilatory Cream Base, Moisturising Agents."
    },
    {
        id: 7,
        name: "Terekeme Psyllium Powder",
        category: "wellness",
        price: 15,
        originalPrice: null,
        image: "images/products/terekeme-psyllium-powder.jpg",
        badge: "100% Natural",
        description: "100% natural psyllium husk powder, a gentle source of dietary fibre that supports healthy digestion. 100 g.",
        usage: "Stir one teaspoon into a large glass of water or juice and drink straight away.",
        ingredients: "100% Psyllium (Plantago ovata) Husk Powder."
    },
    {
        id: 8,
        name: "Vita London Psyllium Husk Capsules",
        category: "wellness",
        price: 19,
        originalPrice: null,
        image: "images/products/vita-london-psyllium-husk.jpg",
        badge: null,
        description: "Psyllium husk fibre with Lactobacillus acidophilus probiotic. 4000 mg, 60 capsules. Vegan friendly, GMO free, made in the UK.",
        usage: "Take daily with plenty of water, as directed on the pack.",
        ingredients: "Psyllium Husk, Lactobacillus acidophilus, Vegan Capsule Shell."
    },
    {
        id: 9,
...
const CATEGORY_LABELS = { skincare: "Skincare", makeup: "Makeup", korean: "Korean Beauty", haircare: "Hair Care", fragrance: "Fragrance", bodycare: "Body Care", wellness: "Wellness" };
